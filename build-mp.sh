...
cmake_opt='-DPROC_TARGET_NUMBER="1" -DPROC_LABEL="generic_processor" -DCACHE_NAME_SUFFIX="5-dev" -DWITH_LTO="ON" -DCMAKE_OSX_DEPLOYMENT_TARGET="10.9"  -DLENSFUNDBDIR="./share/lensfun" -DCMAKE_CXX_FLAGS="-std=c++11"'
